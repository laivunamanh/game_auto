...
interface CheckoutSummaryMomoProps {
  games: Game[]; // Nhận danh sách game đã chọn
}

const CheckoutSummaryMomo: React.FC<CheckoutSummaryMomoProps> = ({ games }) => {
  ...
  const handleConfirmPayment = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        navigate("/momoment", { state: { selectedItems, order_id: data.data.order_id } });
      } else {
...
export default CheckoutSummaryMomo;
